        ...
        <tbody>
          {Res.map((e, i) => (
            <tr key={i}>
              ...
              <td><p>
              <button class="button" onClick={() => Remove(e.stud_id)}>
                <svg
              ...
              <td><p>
                <button class="button1" onClick={() => UpdatePage(e.stud_id)}>
              ...
              {/* <td><p><button className='Delbtn' onClick={() => Remove(e.stud_id)}>Delete</button></p></td> */}
              {/* <td><p><button className='updbtn' onClick={() => UpdatePage(e.stud_id)}>Update</button></p></td> */}
            </tr>
